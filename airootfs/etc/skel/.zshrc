...
# ZSH config
# TODO : add oh-my-zsh with plugins :
#
#
#
# plugins : archlinux, colored-man-pages, git, zsh-autosuggestions, zsh-syntax-highlighting
...
export EDITOR="$(if [[ -n $DISPLAY ]]; then echo 'vim'; else echo 'nano'; fi)"	# vim, nano
